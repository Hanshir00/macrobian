        ...
        body: fields.markdoc({
          ...
          components: {
            ...
            stripeButton: block({
              ...
              description: 'Embed a Stripe Buy Button. Paste the buy-button-id and publishable key from your Stripe dashboard.',
              schema: {
                buttonId: fields.text({
                  label: 'Buy button ID',
                  description: 'e.g. buy_btn_xxx',
                  validation: { isRequired: true },
                }),
                publishableKey: fields.text({
